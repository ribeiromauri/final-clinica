...
BEGIN
	BEGIN TRY
		BEGIN TRANSACTION
			INSERT INTO ADM_USUARIOS(TIPO_USUARIO, DNI_USUARIO, CONTRASEÑA) VALUES (3, @DNI, @CONTRASEÑA, 1)
...
BEGIN
	BEGIN TRY
		BEGIN TRANSACTION
			INSERT INTO ADM_USUARIOS(TIPO_USUARIO, DNI_USUARIO, CONTRASEÑA) VALUES (2, @DNI, @CONTRASEÑA, 1)
